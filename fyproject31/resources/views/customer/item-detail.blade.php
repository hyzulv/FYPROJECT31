            ...
            @else
                <div class="placeholder-image-large">
                    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <ellipse cx="60" cy="75" rx="42" ry="18" stroke="#d1986a" stroke-width="2" fill="rgba(209,152,106,0.1)"/>
                        <path d="M38 68 Q60 30 82 68" stroke="#d1986a" stroke-width="2" fill="rgba(209,152,106,0.1)"/>
                        <circle cx="60" cy="45" r="4" fill="#d1986a"/>
                    </svg>
                </div>
            @endif
        </div>
